...
export default function AdminHero({
  ...
  return (
    <header
      className={`relative overflow-hidden rounded-[28px] border px-7 py-6 text-white pt-20 ${styles.border} ${styles.bg} ${styles.shadow} ${className}`.trim()}
    >
