...
const LEFT_MENU_ITEMS = [
  ...
  { name: "Client Subscriptions", href: "#", icon: Users, active: true },
...
const RIGHT_MENU_ITEMS = [
  { id: "overview", label: "Client Subscriptions" },
  { id: "overview1", label: "Add Ads Client" },
  { id: "key-features", label: "Get Subscribed Clients" },
  { id: "campaign-management", label: "Unsubscribe Client" },
];
            ...
            <section id="overview1" className="scroll-mt-24 mb-16 space-y-8">
              ...
              <div className="rounded-[48px] bg-white p-8 mx-auto max-w-2xl shadow-2xl">
                  <p className="mt-3 text-sm text-black">
                    ...
                    Subscribes a new client to receive campaigns. <br />
                    <br />
                    Request Body: <br />
                    <br />
                    {'{'} <br />
                    "phoneNumber": "+260971234567", <br />
               ...
               <h3 className="text-2xl font-semibold text-white">
                ...
                <div className="rounded-[48px] bg-white p-8 mx-auto max-w-2xl shadow-2xl">
                  <p className="mt-3 text-sm text-black">
                    ...
                    Authorization: Bearer {'<token>'} <br />
                    Retrieves paginated list of subscribed clients.
                  </p>
                </div>
            </section>
               ...
               <h3 className="text-2xl font-semibold text-white">Unsubscribe Client</h3>
                <div className="rounded-[48px] bg-white p-8 mx-auto max-w-2xl shadow-2xl">
                  <p className="mt-3 text-sm text-black">
                    ...
                    Authorization: Bearer {'<token>'} <br />
                    Unsubscribes a client from receiving campaigns.
                  </p>
              </div>
            </section>
